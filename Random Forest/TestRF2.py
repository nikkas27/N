...
plt.title('University Selection System\nRandom Forest Algo')
plt.legend()
plt.savefig('D:/University Selection System/Results of Algos/RandomForestPrediction.png')
plt.show()



slices = [(c[0]*100),(c[1]*100),(c[2]*100)]
activities = ['GRE','TOEFL','GPA']
...
plt.savefig('D:/University Selection System/Results of Algos/RandomForestImportance.png')
plt.show()
